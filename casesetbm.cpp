...
void bench(const string tname) {
    ifstream inputFile(tname); 
        ...
        cout << mySet.size() << ',' << total * 1000.0 / findQueries.size() << '\n';
        inputFile.close();
}
...
int main() {
    ...
    cout << "test_size,avg_runtime" << endl;
    bench("tests/random_access_10_1000000.txt");
    bench("tests/random_access_100_1000000.txt");
    bench("tests/random_access_1000_1000000.txt");
    bench("tests/random_access_10000_1000000.txt");
    bench("tests/random_access_100000_1000000.txt");
    bench("tests/random_access_1000000_1000000.txt");
    return 0;
}